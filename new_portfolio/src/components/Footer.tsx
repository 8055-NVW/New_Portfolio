...
<footer
  ...
  >
    <div className="p-5 px-6 md:px-12 lg:px-24 py-12 flex flex-col md:flex-row items-center justify-center gap-10 md:gap-16 max-w-7xl mx-auto">
      
      {/* Left Section */}
      <div className="flex flex-col items-center text-slate-100 text-center md:w-[40%] lg:w-[35%]">
        ...
        <div className="flex gap-6">
          ...
          <a href="https://www.linkedin.com/in/vivian-lopes-44094798/" target="_blank">
            <img src="/assets/linkedin-white.svg" alt="linkedin" className="h-[40px]" />
          </a>
          <a href="https://github.com/8055-NVW" target="_blank">
      ...
      {/* Divider */}
      <div className="hidden md:block border-l h-[260px] border-slate-300/30" />

      {/* Right Section */}
      <div className="bg-[#000000ab] backdrop-blur-xl rounded-2xl p-6 w-full max-w-[500px] md:w-[45%]">
